...
namespace VijayAnand.BlazorTemplates
{
    internal sealed partial class Vsix
    {
        ...
        public const string Tags = "Blazor, Desktop, WindowsForms, WinForms, WPF, Windows, Template, BlazorWebView, Hybrid, Razor, Web, GA, .NET MAUI, Client, Modernization, .NET 7, .NET 8, .NET 9, Preview";
    }
}
