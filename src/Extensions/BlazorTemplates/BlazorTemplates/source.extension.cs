...
namespace VijayAnand.BlazorTemplates
{
    internal sealed partial class Vsix
    {
        ...
        public const string Tags = "Blazor, Desktop, WindowsForms, WinForms, WPF, Windows, Template, BlazorWebView, Hybrid, Razor, Web, GA, .NET MAUI, Client, Modernization, .NET 8, .NET 9, .NET 10, Preview, ARM64, SLNX, VS2022, VS2026, Insiders, .NET 11";
    }
}
